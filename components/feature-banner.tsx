...
export type BannerArgs = { imageSource: StaticImageData, secondImageSource: StaticImageData, alt: string, secondAlt: string, titleText: string, descriptionText: string, reverse?: boolean };
