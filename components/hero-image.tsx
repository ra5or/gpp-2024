...
export const HeroImage = (props) => {
    ...
    let buttonContents = showButton && buttonText ? <Button variant="flat" size="lg" className="bg-slide-blue/100 text-menu-color m-5 w-36 mx-auto font-semibold">{buttonText}</Button> : null;      
    return (
